...
- Waiting room and game screen share one renderer instance — no re-init, and the renderer warm-starts before the match. **(Amended by ADR-0006 — the zoom mechanism is no longer a CSS transform.)**
